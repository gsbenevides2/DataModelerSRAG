...
COMMENT ON TABLE trabalha_animais IS
    'Tabela de metadados que lista as possíveis situações para alguém que trabalha com animais.';

COMMENT ON COLUMN trabalha_animais.tan_id IS
    'Identificador do tipo da situação se o paciente trabalha com animais.';

COMMENT ON COLUMN trabalha_animais.tan_descricao IS
    'Descrição do tipo da situação se o paciente trabalha com animais.';
