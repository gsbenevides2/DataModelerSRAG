...
COMMENT ON TABLE idades_gestacionais IS
    'Tabela de metadados que lista as possíveis idades gestacionais da paciente.';

COMMENT ON COLUMN idades_gestacionais.idg_id IS
    'Identificador do tipo de idade gestacional que o paciente possa ter.';

COMMENT ON COLUMN idades_gestacionais.idg_descricao IS
    'Descrição da idade gestacional que o paciente possa ter.';
