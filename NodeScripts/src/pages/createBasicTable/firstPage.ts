...
export function createBasicTableFirstPage(): void {
  win.setWindowTitle("Ajudante de Preparação de Banco Oracle - SRAG");
  ...
  const subTitle = createTextLabel(
    "Precisamos de algumas informações para continuar. Iremos criar o usuário APP, vamos rodar a DDL e a DML dos metadados, por causa disso, precisamos de informações da conexão de adminstrador."
  );
  ...
  textEditUser.setText("SYSTEM");
  textEditPassword.setText("oracle");
