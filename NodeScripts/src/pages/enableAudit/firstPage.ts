...
export function enableAuditFirstPage(): void {
  ...
  const subTitle = createTextLabel(
    "Precisamos de algumas informações para continuar. Já preenchemos as informaçõs com o usuário SYSTEM padrão mas você pode alterar se quiser."
  );
